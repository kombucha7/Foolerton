...
currentToDateString.textContent = temp_date.toDateString() == todayDate.toDateString() ? "Today" : format(temp_date);
// console.log(`Current Date: ${temp_date}`);
// console.log(`Today's Date: ${todayDate}`);
// console.log(`Current To Date String: ${currentToDateString.textContent}`);
